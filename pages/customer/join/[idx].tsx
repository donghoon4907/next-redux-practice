...
import { ContactHisTabpanel } from '@partials/hr/customer/tabpanels/ContactHis';
import { HoldingContractTabpanel } from '@partials/hr/customer/tabpanels/HoldingContract';
import { OtherContractTabpanel } from '@partials/hr/customer/tabpanels/OtherContract';
import { SecuredDebtTabpanel } from '@partials/hr/customer/tabpanels/SecuredDebt';
import { FamilyTabpanel } from '@partials/hr/customer/tabpanels/Family';
import { AnniversaryTabpanel } from '@partials/hr/customer/tabpanels/Anniversary';
...
const Customer: NextPage<CustomerState> = ({ customer }) => {
    ...
    // 고객구분
    const [division] = useSelect(customerConstants.division, null);
    // 주민번호
