...
import { createUserHistory } from '@actions/customer/set-user-history.action';
import { createContact } from '@actions/customer/set-contact.action';
    ...
    return (
        <>
            ...
            <CustomerForm
                ...
                defaultComRegNum={customer.custtype === 1 ? customer.idnum : ''}
                defaultBirthday={
                ...
                defaultMobile={customer.custtype === 0 ? customer.mobile : ''}
                defaultMobileCom={defaultMobileCom}
                defaultPhone={customer.custtype === 1 ? customer.mobile : ''}
...
export const getServerSideProps = wrapper.getServerSideProps(
    permissionMiddleware(async ({ getState, dispatch, sagaTask }, ctx) => {
        const { query } = ctx;
